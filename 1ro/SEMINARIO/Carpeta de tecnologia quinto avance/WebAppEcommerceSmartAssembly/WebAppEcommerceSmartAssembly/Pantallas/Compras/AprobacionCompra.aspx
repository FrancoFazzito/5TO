<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AprobacionCompra.aspx.cs" Inherits="WebAppEcommerceSmartAssembly.Pantallas.Compras.AprobacionCompra" %>
    ...
    <p>
        <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Height="245px" Width="834px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
            ...
            <Columns>
                ...
                <asp:ButtonField ButtonType="Button" Text="Detalles" />
            </Columns>
